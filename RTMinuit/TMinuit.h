...
public:
   ...
   //this one need special look
   virtual void   mncrck(const string& crdbuf, int maxcwd, const string &comand, int &lnc
   ...
   virtual void   mngrad();
   virtual void   mnhelp(const string& comd);
   ...
   //TODO: this one also need special attention
   ...
   virtual void   mnpout(int iuext, string &chnam, double &val, double &err, double &xlolim, double &xuplim, int &iuint) const;
   ...
   virtual void   SetGraphicsMode(bool mode=true) {fGraphicsMode = mode;}
